...
use Komputerwiz\Security\Token\SecureToken\Aes256CbcSha512SecureToken;
use Komputerwiz\Security\Token\SecureToken\SecureTokenInterface;
use Komputerwiz\Security\Token\SecureToken\TokenException;

class Aes256CbcSha512SecureTokenTest extends \PHPUnit_Framework_TestCase
{
    /**
    ...
    {
        $encryptionKey = Aes256CbcSha512SecureToken::pbkdf2('testkey1', 'testsalt', 10000);
        $signingKey = Aes256CbcSha512SecureToken::pbkdf2('testkey2', 'testsalt', 10000);
        $this->token = new Aes256CbcSha512SecureToken($encryptionKey, $signingKey);
    }
